 ...
 /*! smooth-scroll v16.1.3 | (c) 2020 Chris Ferdinandi | MIT License | http://github.com/cferdinandi/smooth-scroll */            window.Element && !Element.prototype.closest && (Element.prototype.closest = function(e) {
    ...
    (() => {
        ...
        function initSliders() {
            if (document.querySelector(".portfolio-slider")) new swiper_core_Swiper(".portfolio-slider", {
        ...
        const script_menuClose = document.querySelector(".menu-close");
        ...
        if (menu) {
            ...
            script_menuClose.addEventListener("click", (ev => {
